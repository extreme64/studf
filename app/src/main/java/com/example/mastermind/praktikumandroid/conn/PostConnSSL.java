 ...
 */
public class PostConnSSL extends AsyncTask<String, Void, Void> {
    ...
    protected Void doInBackground(String... params) {
        try {
           ...
           // final TextView outputView = (TextView) findViewById(R.id.showOutput);
            ...
            ((MainActivity)context).runOnUiThread(new Runnable() {   // MainActivity.this.runOnUiThread(new Runnable() {

                @Override
                public void run() {
                    System.out.print("OUT post >>>>> " + output);
                    progress.dismiss();
                }
            });
